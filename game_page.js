...
function send() {
	get_word = document.getElementById("num1").value;
	get_word2 = document.getElementById("num2").value;
	
	console.log(get_word + get_word2);

    suma = get_word * get_word2;
	
	console.log(suma);
	

    question_word = "<h4 id='word_display'> "+get_word+"x"+ get_word2+"</h4>";
